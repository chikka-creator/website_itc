      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative flex items-center justify-center w-12 h-12 bg-gradient-to-br from-[var(--color-brand-amber)] to-orange-600 rounded-2xl shadow-[0_0_30px_rgba(245,158,11,0.3)]">
              <ShieldAlert className="text-[#0a0a0f]" size={24} />
          ...
          <button
            ...
            className="p-3 rounded-xl bg-white/5 text-white/50 hover:bg-red-500/10 hover:text-red-400 transition-all border border-transparent hover:border-red-500/20"
            title="Disconnect"
          >
            <LogOut size={18} />
          </button>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-white/5 border border-white/5 rounded-2xl p-4 flex flex-col justify-between group hover:bg-white/10 transition-colors">
            <FileText className="text-blue-400 mb-3 opacity-50 group-hover:opacity-100 transition-opacity" size={20} />
            <div>
        ...
        <div className="mt-auto pt-6 flex flex-col gap-2">
          ...
          >
            <span className="flex items-center gap-3 font-medium">
              <FileText size={18} className={activeTab === "tasks" ? "text-blue-400" : ""} />
              Ingress Queue
            </span>
            {activeTab === "tasks" && <div className="w-1.5 h-1.5 rounded-full bg-blue-400" />}
          </button>
          <button
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                  {tasks.map((task, i) => (
                    <motion.div 
                      ...
                      className="group relative p-6 rounded-2xl bg-white/5 border border-white/5 hover:border-blue-500/30 hover:bg-blue-900/10 transition-all overflow-hidden"
                    >
                      {/* Decorative elements */}
                      <div className="absolute top-0 right-0 w-16 h-16 bg-blue-500/10 blur-xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
                      <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-400 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />

                      <div className="flex justify-between items-start mb-4 relative z-10">
                        <div className="pr-4">
                          <h3 className="text-xl font-semibold mb-1 text-white group-hover:text-blue-100 transition-colors">{task.title}</h3>
                      ...
                      <div className="flex items-center justify-between border-t border-white/5 pt-4 relative z-10">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-[var(--color-brand-amber)] text-[#0a0a0f] text-xs font-bold uppercase tracking-wider hover:scale-105 transition-transform"
                        >
                ...
                {showProjectForm && (
                  ...
                  >
                    <div className="p-1 rounded-2xl bg-gradient-to-br from-[var(--color-brand-amber)] to-[var(--color-brand-amber)]/10">
                      <form onSubmit={handleSubmitProject} className="bg-[#0a0a0f] rounded-xl p-6 md:p-8 relative">
                        ...
                        {projectMessage && (
                          <div className={`mb-6 p-4 rounded-xl border ${projectMessage.includes("berhasil") ? "bg-green-500/10 border-green-500/20 text-green-400" : "bg-red-500/10 border-red-500/20 text-red-400"}`}>
                            {projectMessage}
                          </div>
                        )}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                          ...
                          <div className="space-y-2">
                            ...
                            >
                              <option value="Programming" className="bg-[#0a0a0f]">Programming</option>
                              <option value="Desain Grafis" className="bg-[#0a0a0f]">Desain Grafis</option>
                              <option value="Multimedia" className="bg-[#0a0a0f]">Multimedia</option>
                              <option value="Jaringan" className="bg-[#0a0a0f]">Jaringan</option>
                            </select>
                          </div>
                        </div>
                        ...
                        <button
                          ...
                          className="w-full flex items-center justify-center gap-2 py-4 rounded-xl bg-[var(--color-brand-amber)] text-[#0a0a0f] font-bold tracking-wide hover:brightness-110 active:scale-[0.98] transition-all disabled:opacity-50"
                        >
                      ...
                      <div className="relative rounded-3xl overflow-hidden bg-black/40 border border-white/10 backdrop-blur-md">
                        ...
                        <div className="w-full h-48 bg-white/5 relative overflow-hidden flex items-center justify-center group-hover:bg-white/10 transition-colors">
                          ...
                          <div className="absolute bottom-4 left-4 right-4 flex justify-between items-end">
                            ...
                            <div className="flex gap-2">
                              {project.link_url && (
                                <a href={project.link_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 flex items-center justify-center bg-white/20 hover:bg-[var(--color-brand-amber)] hover:text-[#0a0a0f] rounded-full backdrop-blur-md transition-colors">
                                  <LinkIcon size={14} />
                                </a>
                              )}
